...
import LiveTranscriptionDemo from "../components/home/LiveTranscriptionDemo";
...
export default function Home() {
  ...
  return (
    <div className="relative bg-white selection:bg-primary-500/30 selection:text-primary-900">
      ...
      {/* 3. Interactive live transcription + diarization demo */}
      <LiveTranscriptionDemo />

      {/* 4. The Intelligence Gap */}
      <ProblemSolution />

      {/* 5. Omnichannel Speaker Identification (Online & Offline) */}
      <OmnichannelCapture />

      {/* 6. Flagship product dashboard */}
      <AgentSurveillanceShowcase />

      {/* 7. Proof of tech, Indian audio */}
